...
g_config.skill = 
{
	...
	[1001] = 
	{
		...
		--技能图标路径
		img_path = g_config:to_monster_img_path("icon_skill_destructive_ray.png"),
		--技能范围，0的话就是全范围
		range = 0,
		--技能是否需要选择目标
		is_need_target = false,
		...
		--技能粒子路径
	 	particle_path = g_config:to_particle_path("snowstorm.plist"),
	 	--粒子放置的位置
	...
	[1002] = 
	{
		...
		healing_level_plus = 0,
	 	...
	 	particle_path = g_config:to_particle_path("impactwave.plist"),
	...
	[1004] = 
	{
		...
		img_path = g_config:to_monster_img_path("icon_skill_eager_for_fight.png"),
		range = 0,
		is_need_target = false,
		cost = 3,
		damage = 0,
