...
Config.Monster = {
	--编号		名称							稀有度		等级				攻击类型												移动类型										血量			伤害					最大怒气值		物理防御					魔法防御				移动力			速度					护甲穿透						技能列表									头像图片资源名称														角色图片资源名称																											描述
...
Config.Monster_animate = {
	[1] = {
		...
		stand		= function(animation) return cc.Animate3D:createWithFrames(animation,0,89) end,
	...
	[2] = {
		...
		stand		= function(animation) return cc.Animate3D:createWithFrames(animation,0,52) end,
	...
	[3] = {
		...
		stand 		= function(animation) return cc.Animate3D:createWithFrames(animation,0,40) end,
		...
		stand2		= function(animation) return cc.Animate3D:createWithFrames(animation,337,429) end,
	...
	[4] = {
		...
		stand2		= function(animation) return cc.Animate3D:createWithFrames(animation,145,216) end,
	...
	[5] = {
		...
		stand		= function(animation) return cc.Animate3D:createWithFrames(animation,0,25) end,
