...
g_config.monter = 
{
	...
	{id = 1		,name = "Grunt"				,rarity = 1	,level = 1		,attack_type = g_config.monster_attack_type.WARRIOR	,move_type = g_config.monster_move_type.WALK	,hp = 100	,damage = 25		,anger = 4		,physical_defense = 1	,magic_defense = 1	,mobility = 2	,initiative = 42	,defense_penetration = 1	,skill = nil							,face_img_path = g_config.monster_img_path.."face_orcwarrior.png"		,char_img_path = g_config.monster_img_path.."char_orcwarrior.png"		,model_path = g_config.model_path.."grunt.c3b"		,														description = "This is a monster used to test!"	,},
	{id = 2		,name = "Wild Bear"			,rarity = 1	,level = 1		,attack_type = g_config.monster_attack_type.CLO_MAG	,move_type = g_config.monster_move_type.WALK	,hp = 240	,damage = 30		,anger = 4		,physical_defense = 1	,magic_defense = 1	,mobility = 2	,initiative = 50	,defense_penetration = 1	,skill = nil							,face_img_path = g_config.monster_img_path.."face_wildreferee.png"	,char_img_path = g_config.monster_img_path.."char_wildreferee.png"	,model_path = g_config.model_path.."bear.c3b"			,														description = "This is a monster used to test!"	,},
	{id = 3		,name = "Jaina"				,rarity = 3	,level = 1		,attack_type = g_config.monster_attack_type.FAR_MAG	,move_type = g_config.monster_move_type.WALK	,hp = 200	,damage = 40		,anger = 4		,physical_defense = 2	,magic_defense = 2	,mobility = 3	,initiative = 65	,defense_penetration = 1	,skill = g_config.skill[1001]				,face_img_path = g_config.monster_img_path.."face_frostarcher.png"	,char_img_path = g_config.monster_img_path.."char_frostarcher.png"	,model_path = g_config.model_path.."jaina.c3b"		,attack_particle =g_config.Particle.magic_ball			,description = "This is a monster used to test!"	,},
	{id = 4		,name = "Skeleton"			,rarity = 2	,level = 1		,attack_type = g_config.monster_attack_type.WARRIOR	,move_type = g_config.monster_move_type.WALK	,hp = 200	,damage = 50		,anger = 4		,physical_defense = 2	,magic_defense = 2	,mobility = 3	,initiative = 70	,defense_penetration = 1	,skill = g_config.skill[1003]				,face_img_path = g_config.monster_img_path.."face_skeleton.png"		,char_img_path = g_config.monster_img_path.."char_skeleton.png"		,model_path = g_config.model_path.."skeleton.c3b"		,														description = "This is a monster used to test!"	,},
	{id = 5		,name = "Red Dragon"		,rarity = 4	,level = 1		,attack_type = g_config.monster_attack_type.WARRIOR	,move_type = g_config.monster_move_type.FLY	,hp = 200	,damage = 60		,anger = 4		,physical_defense = 2	,magic_defense = 2	,mobility = 4	,initiative = 40	,defense_penetration = 2	,skill = nil							,face_img_path = g_config.monster_img_path.."face_firedragon.png"		,char_img_path = g_config.monster_img_path.."char_firedragon.png"		,model_path = g_config.model_path.."reddragon.c3b"	,														description = "This is a monster used to test!"	,},
	{id = 6		,name = "The Captain"		,rarity = 3	,level = 1		,attack_type = g_config.monster_attack_type.WARRIOR	,move_type = g_config.monster_move_type.WALK	,hp = 300	,damage = 55		,anger = 4		,physical_defense = 2	,magic_defense = 2	,mobility = 3	,initiative = 45	,defense_penetration = 1	,skill = g_config.skill[1004]				,face_img_path = g_config.monster_img_path.."face_paladin.png"		,char_img_path = g_config.monster_img_path.."char_paladin.png"		,model_path = g_config.model_path.."captain.c3b"		,														description = "This is a monster used to test!"	,},
	{id = 7		,name = "Tauren"			,rarity = 2	,level = 1		,attack_type = g_config.monster_attack_type.WARRIOR	,move_type = g_config.monster_move_type.WALK	,hp = 360	,damage = 40		,anger = 4		,physical_defense = 2	,magic_defense = 2	,mobility = 3	,initiative = 48	,defense_penetration = 1	,skill = g_config.skill[1002]				,face_img_path = g_config.monster_img_path.."face_tauren.png"			,char_img_path = g_config.monster_img_path.."char_tauren.png"			,model_path = g_config.model_path.."tauren.c3b"		,														description = "This is a monster used to test!"	,},
}
