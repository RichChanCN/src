...
Config.Monster = {
	...
	{id = 2		,name = "XXXX"				,rarity = 1	,level = 5		,attack_type = Config.Monster_attack_type.CLO_MAG		,hp = 80	,damage = 30	,physical_defense = 5	,magic_defense = 5	,mobility = 5	,initiative = 50	,defense_penetration = 0	,skills_list = {1001,	1002,	1003,}	,face_img_path = Config.monster_img_path.."face_infantry.png"		,char_img_path = Config.monster_img_path.."char_infantry.png"		,model_path = ""		,description = "This is a monster used to test!"	,},
	{id = 3		,name = "argqargq"			,rarity = 2	,level = 4		,attack_type = Config.Monster_attack_type.FAR_MAG		,hp = 50	,damage = 40	,physical_defense = 5	,magic_defense = 5	,mobility = 5	,initiative = 50	,defense_penetration = 0	,skills_list = {1001,	1002,	1003,}	,face_img_path = Config.monster_img_path.."face_infantry.png"		,char_img_path = Config.monster_img_path.."char_infantry.png"		,model_path = ""		,description = "This is a monster used to test!"	,},
	{id = 4		,name = "HSHSHSHHS"			,rarity = 3	,level = 7		,attack_type = Config.Monster_attack_type.SHOOTER		,hp = 50	,damage = 50	,physical_defense = 5	,magic_defense = 5	,mobility = 5	,initiative = 50	,defense_penetration = 0	,skills_list = {1001,	1002,	1003,}	,face_img_path = Config.monster_img_path.."face_infantry.png"		,char_img_path = Config.monster_img_path.."char_infantry.png"		,model_path = ""		,description = "This is a monster used to test!"	,},
